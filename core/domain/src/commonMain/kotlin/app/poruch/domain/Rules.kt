 ...
 */
object SafetyRules {
    /** «Поряд» — платформа для дорослих. Знизити — рішення політики з модерацією на додачу. */
...
object DiscoveryRules {
    ...
    /** Скільки закладів показує пошук. Сервер приймає 1–50; більше за екран списку не читають. */
    const val PLACES_LIMIT = 20
    /** Скільки подій закладу бере «Ще в цьому місці». Стеля сервера за замовчуванням. */
    const val PLACE_EVENTS_LIMIT = 100
