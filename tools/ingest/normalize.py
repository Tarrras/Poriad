...
_BY_TYPE = {
    ...
    "ChildrensEvent": "kids",
    "EducationEvent": "social", "BusinessEvent": "social", "SocialEvent": "social",
}
...
_LEXICON = [
    ...
    ("outdoors", r"похід|прогулянк|екскурс|треккінг|сплав|пікнік|на природі|парк[уі]\b"),
    ...
    ("music", r"концерт|музичн|джаз|рок|реп|діджей|dj\b|акустичн|сольник"),
    ("social", r"розмовн клуб|нетворк|мітап|meetup|воркшоп|майстер.?клас|знайомств|спілкуванн|конференц"),
]
